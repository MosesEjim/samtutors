            ...
            <div class="col-lg-8 posts-list">
                <div class="single-post">
                    <div class="feature-img">
                        <img class="img-fluid" src="/storage/photos/{{$article->photo}}" alt="">
                    </div>
                    <div class="blog_details">
                        <h2>{{$article->title}}</h2>
                        <ul class="blog-info-link mt-3 mb-4">
                            <li><a href="#"><i class="far fa-user"></i> Education</a></li>
                            <li><a href="#"><i class="far fa-comments"></i> {{count($article->comments)}} Comments</a></li>
                        </ul>
                                ...
                                <div class="desc">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <p class="date">{{date('d-F-Y h:i:s', strtotime($comment->created_at))}} </p>
                                        </div>
