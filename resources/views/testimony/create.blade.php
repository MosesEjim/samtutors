    ...
    <div class="col-xl-8 order-xl-1">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form action='{{route('testimony.store')}}' enctype='multipart/form-data' method='POST'>
                    @csrf
                    <div class="pl-lg-4">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="testifier" class="form-control" placeholder="Name of Testifier">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-email">Testimony</label>
                                    <textarea rows="4" class="form-control" name='testimony' placeholder="Testimony goes here" id='article-ckeditor'></textarea>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
