        ...
        <div class="row align-items-sm-center align-items-lg-stretch">
            ...
            <div class="col-md-5 col-lg-5">
                <div class="learning_member_text">
                    ...
                    <p>Welcome to the OUR Home Tutor Application Form. With this form you would be able to apply for a personal home tutor to teach your kid/ward in your home. Please feel free to call 08163405391,
                        0814 321 6891,
                        0703 836 9526,
                        0906 455 0632,
                        ...
                        <a class="btn_1" href="{{route('apply.form')}}">Apply</a>
                </div>
            </div>
        </div>
    </div>
